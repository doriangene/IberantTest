...
import { MyUserItemStore, NewMyUserItemStore } from './stores/my-user-store';
...
export default function configureStore(
    ...
    storeBuilder.addRepository(new MyUserItemStore() as any);
    storeBuilder.addRepository(new NewMyUserItemStore() as any);
